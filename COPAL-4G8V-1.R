#Cow Pairing Algorithm for up to Size 4 Groups and 8 Modifiable Variables. Version 1. 
#(COPAL-4G8V-1)
...
#NOTE1: This code uses 8 placeholder variable names -- 4 of them are also used
...
#NOTE2: For this code to work, YOU MUST HAVE all 9 variables in your original 
...
DF_Main <- read.csv("Base_Original_Vacas.csv")
  ...
  DF_Comparisons_COW2 <- DF_Comparisons_COW2 |> 
    mutate(
      CV_TOTAL = CV_FilterMinMax_O + CV_Variable_A + CV_FilterEquals_Y +
                 ...
                 CV_FilterEquals_Z + CV_Variable_D
    )
